...
BEGIN
    ...
    INSERT INTO public.lessons (organization_id, title, training_module_id, block_type, block_order, content_data)
    VALUES (v_org_a_id, 'Guest Greeting & Check-In', v_master_course_id, 'text', 1, '{}'::jsonb);
