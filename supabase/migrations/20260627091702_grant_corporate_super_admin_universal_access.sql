...
-- The authz layer (helper functions + ~52 policies) only recognized
-- regional_admin/regional_hr, locking corporate_admin out of most manage/write
-- operations. Additive change: only elevates the two top roles.
-- ============================================================================
