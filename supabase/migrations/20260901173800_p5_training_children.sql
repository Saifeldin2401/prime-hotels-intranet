...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.course_source_documents ADD CONSTRAINT course_source_documents_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.course_source_documents x SET organization_id = COALESCE(
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.module_skills ADD CONSTRAINT module_skills_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.module_skills x SET organization_id = COALESCE(
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.source_change_flags ADD CONSTRAINT source_change_flags_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.source_change_flags x SET organization_id = COALESCE(
  (SELECT m.organization_id FROM public.training_modules m WHERE m.id = x.training_module_id),
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.training_certificate_settings ADD CONSTRAINT training_certificate_settings_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.training_certificate_settings x SET organization_id = COALESCE(
  (SELECT m.organization_id FROM public.training_modules m WHERE m.id = x.module_id),
  'e0000000-0000-0000-0000-000000000001'::uuid) WHERE x.organization_id IS NULL;
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.training_module_prerequisites ADD CONSTRAINT training_module_prerequisites_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.training_module_prerequisites x SET organization_id = COALESCE(
  (SELECT m.organization_id FROM public.training_modules m WHERE m.id = x.module_id),
  'e0000000-0000-0000-0000-000000000001'::uuid) WHERE x.organization_id IS NULL;
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.training_module_versions ADD CONSTRAINT training_module_versions_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.training_module_versions x SET organization_id = COALESCE(
  (SELECT m.organization_id FROM public.training_modules m WHERE m.id = x.training_module_id),
  'e0000000-0000-0000-0000-000000000001'::uuid) WHERE x.organization_id IS NULL;
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.training_block_progress ADD CONSTRAINT training_block_progress_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.training_block_progress x SET organization_id = COALESCE(
  (SELECT m.organization_id FROM public.training_modules m WHERE m.id = x.training_module_id),
  'e0000000-0000-0000-0000-000000000001'::uuid) WHERE x.organization_id IS NULL;
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.course_visual_assets ADD CONSTRAINT course_visual_assets_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.course_visual_assets x SET organization_id = COALESCE(
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.training_path_modules ADD CONSTRAINT training_path_modules_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.training_path_modules x SET organization_id = COALESCE(
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.user_path_enrollments ADD CONSTRAINT user_path_enrollments_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.user_path_enrollments x SET organization_id = COALESCE(
  (SELECT p.organization_id FROM public.training_paths p WHERE p.id = x.path_id),
  'e0000000-0000-0000-0000-000000000001'::uuid) WHERE x.organization_id IS NULL;
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.course_competencies ADD CONSTRAINT course_competencies_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.course_competencies x SET organization_id = COALESCE(
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.course_modules ADD CONSTRAINT course_modules_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.course_modules x SET organization_id = COALESCE(
  (SELECT c.organization_id FROM public.courses c WHERE c.id = x.course_id),
  'e0000000-0000-0000-0000-000000000001'::uuid) WHERE x.organization_id IS NULL;
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.training_certificates ADD CONSTRAINT training_certificates_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.training_certificates x SET organization_id = COALESCE(
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints
    ...
    ALTER TABLE public.training_session_attendees ADD CONSTRAINT training_session_attendees_organization_id_fkey
      FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;
  END IF;
END $$;
UPDATE public.training_session_attendees x SET organization_id = COALESCE(
...
CREATE POLICY course_source_documents_write ON public.course_source_documents
  ...
  USING (
    ...
    AND (
      ...
      OR EXISTS (SELECT 1 FROM public.training_modules tm
        WHERE tm.id = course_source_documents.training_module_id AND tm.created_by = (SELECT auth.uid()))
    )
  )
  WITH CHECK (
    org_visible(organization_id)
...
CREATE POLICY training_module_versions_select ON public.training_module_versions
  ...
  USING (
    (
      ...
      AND (
        is_tenant_content_editor(organization_id)
        OR EXISTS (SELECT 1 FROM public.training_modules m
