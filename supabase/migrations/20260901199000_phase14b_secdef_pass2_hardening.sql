...
-- Phase 14b: SECURITY DEFINER pass-2 hardening — lock cron/service-only + internal helper
-- functions away from client roles, gate set_ai_provider_health, force log_content_change actor.
...
-- set_ai_provider_health: no auth check at all -> any user could disable platform AI.
...
-- log_content_change: force actor = caller
