...
BEGIN
  ...
  -- 2. Role Check (Must be a manager/admin or staff)
  -- Replaced 'maintenance' with valid enum values found: regional_admin, regional_hr, property_manager, property_hr, department_head, staff
  IF NOT EXISTS (
