-- ============================================================================
-- MIGRATION: harden_totp_helpers_and_has_profile_access
...
--    path (pg_catalog, public, extensions) -- matching the convention used
--    elsewhere in this schema -- rather than rewriting the verified function
--    bodies, since `position(x in y)` is non-qualifiable SQL syntax.
--
