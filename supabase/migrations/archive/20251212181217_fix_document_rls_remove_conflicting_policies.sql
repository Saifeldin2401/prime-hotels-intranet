-- Drop conflicting policies that allow staff to see unpublished documents
DROP POLICY IF EXISTS "Enable read access for users who can view the document" ON documents;
...
-- Create a single, strict RLS policy for documents
CREATE POLICY "documents_select_strict_visibility"
