-- Update AI Governance Cron Schedules to send internal secret header
    ...
    select
      net.http_post(
        ...
        headers:=jsonb_build_object(
          ...
          'x-ai-cron-secret', (select decrypted_secret from vault.decrypted_secrets where name = 'ai_cron_secret' limit 1)
        )
      ) as request_id;
    $cron$
  );
