-- Fix get_sidebar_counts pending training logic to match learning_assignments schema.
-- learning_assignments does not have a user_id column; targeting is encoded by
