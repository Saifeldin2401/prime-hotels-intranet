...
DROP POLICY IF EXISTS p5_training_progress_select ON public.training_progress;
DROP POLICY IF EXISTS p5_training_progress_insert ON public.training_progress;
DROP POLICY IF EXISTS p5_training_progress_update ON public.training_progress;
DROP POLICY IF EXISTS p5_training_progress_delete ON public.training_progress;
...
DROP POLICY IF EXISTS p5_learning_quizzes_select ON public.learning_quizzes;
DROP POLICY IF EXISTS p5_learning_quizzes_insert ON public.learning_quizzes;
DROP POLICY IF EXISTS p5_learning_quizzes_update ON public.learning_quizzes;
DROP POLICY IF EXISTS p5_learning_quizzes_delete ON public.learning_quizzes;
...
DROP POLICY IF EXISTS p5_certificates_select ON public.certificates;
DROP POLICY IF EXISTS p5_certificates_insert ON public.certificates;
DROP POLICY IF EXISTS p5_certificates_update ON public.certificates;
DROP POLICY IF EXISTS p5_certificates_delete ON public.certificates;
...
DROP POLICY IF EXISTS p5_training_paths_select ON public.training_paths;
DROP POLICY IF EXISTS p5_training_paths_insert ON public.training_paths;
DROP POLICY IF EXISTS p5_training_paths_update ON public.training_paths;
DROP POLICY IF EXISTS p5_training_paths_delete ON public.training_paths;
...
DROP POLICY IF EXISTS p5_training_assignment_rules_select ON public.training_assignment_rules;
DROP POLICY IF EXISTS p5_training_assignment_rules_insert ON public.training_assignment_rules;
DROP POLICY IF EXISTS p5_training_assignment_rules_update ON public.training_assignment_rules;
DROP POLICY IF EXISTS p5_training_assignment_rules_delete ON public.training_assignment_rules;
...
DROP POLICY IF EXISTS p5_training_assignment_submissions_select ON public.training_assignment_submissions;
DROP POLICY IF EXISTS p5_training_assignment_submissions_insert ON public.training_assignment_submissions;
DROP POLICY IF EXISTS p5_training_assignment_submissions_update ON public.training_assignment_submissions;
DROP POLICY IF EXISTS p5_training_assignment_submissions_delete ON public.training_assignment_submissions;
...
DROP POLICY IF EXISTS p5_media_assets_select ON public.media_assets;
DROP POLICY IF EXISTS p5_media_assets_insert ON public.media_assets;
DROP POLICY IF EXISTS p5_media_assets_update ON public.media_assets;
DROP POLICY IF EXISTS p5_media_assets_delete ON public.media_assets;
