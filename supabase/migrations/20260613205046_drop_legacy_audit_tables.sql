...
-- ============================================================
-- STEP 1: Migrate the 4 rows written to audit_logs AFTER the
--         consolidate_audit_logs migration ran.
-- ============================================================
...
-- ============================================================
-- STEP 2: Fix functions that still INSERT into audit_logs
-- ============================================================

-- 2a. log_audit_event_trigger (was rewritten, but old version still exists writing to audit_logs)
...
-- 2b. log_audit_event (old trigger-function variant that writes to audit_logs)
...
-- 2c. log_security_audit_event_v2 (still inserts into audit_logs)
...
-- 2d. check_and_escalate_maintenance (inserts into audit_logs with new_values column — redirect)
...
-- 2e. check_and_escalate_approvals (inserts into audit_logs)
...
-- 2f. check_and_escalate_requests (inserts into audit_logs)
...
-- 2g. Fix security functions writing to security_audit_logs
--     (enable_mfa, disable_mfa, verify_mfa_code, lock_account, revoke_session,
--      revoke_all_other_sessions, enforce_session_limit, log_security_event trigger)
...
-- log_security_event trigger function (writes to security_audit_logs)
...
-- 2h. get_audit_data_for_export — redirect to system_events
...
-- 2i. get_compliance_dashboard_metrics — redirect audit_logs count to system_events
...
-- ============================================================
-- STEP 3: Drop the legacy tables (CASCADE removes any
--         dependent constraints; the _v views reference
--         system_events, not these tables, so they survive)
-- ============================================================
