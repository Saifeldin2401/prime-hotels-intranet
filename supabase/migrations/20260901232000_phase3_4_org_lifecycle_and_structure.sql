...
GRANT EXECUTE ON FUNCTION
  public.set_organization_status(uuid,text,text), public.effective_entitlements(uuid), public.check_entitlement(uuid,text),
  public.get_organization_profile(uuid), public.get_org_structure(uuid),
  public.platform_set_membership(uuid,uuid,text,uuid,uuid,boolean), public.org_is_operational(uuid)
TO authenticated;
