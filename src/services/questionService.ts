    ...
    try {
        ...
        return aiQuestions.map(q => ({
            ...
            options: q.options?.map(opt => ({
                ...
                feedback: opt === q.correct_answer ? (q.explanation || 'Correct!') : undefined
            })),
...
function buildQuestionGenerationPrompt(request: AIQuestionGenerationRequest): string {
    ...
    if (language === 'ar') {
        languageInstruction = `
IMPORTANT: Generate ALL text content in Arabic (العربية). This includes:
- question_text and question_text_ar (both in Arabic)
- options text and text_ar (both in Arabic)
- explanation, hint, and feedback (all in Arabic)
- tags (in Arabic if applicable)`
    } else if (language === 'both') {
        languageInstruction = `
IMPORTANT: Generate content in BOTH English and Arabic:
- question_text (English) and question_text_ar (Arabic)
- options: text (English) and text_ar (Arabic)
- explanation (English), hint (English)`
    } else {
        languageInstruction = `
...
[
  {
    ...
    "question_text_ar": "Arabic question text (if applicable)",
    "question_type": "mcq|true_false|fill_blank",
    "difficulty_level": "easy|medium|hard|expert",
    "options": [
      {"text": "Option A", "text_ar": "Arabic A", "is_correct": false, "feedback": "Why this is wrong"},
      {"text": "Option B", "text_ar": "Arabic B", "is_correct": true, "feedback": "Why this is correct"}
    ],
