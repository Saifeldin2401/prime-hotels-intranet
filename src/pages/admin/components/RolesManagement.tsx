...
const TENANT_ROLES_CATALOG: RoleDefinition[] = [
  ...
  },
  {
    ...
    description: 'Manages departments, people, settings and learning programs across the organization.',
  ...
  },
  {
    ...
    description: 'Manages content and standards dedicated to one brand.',
