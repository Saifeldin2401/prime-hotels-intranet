...
export default function KnowledgeLibrary() {
    ...
    return (
        <>
            <div className="flex min-h-[calc(100vh-120px)] flex-col overflow-hidden rounded-xl border border-gray-100 bg-white shadow-xl lg:h-[calc(100vh-120px)] lg:flex-row">
                {/* Sidebar */}
                ...
                {/* Main Content */}
                <div className="flex-1 flex flex-col min-w-0 bg-gray-50/30 lg:min-h-0">
                    {/* Header Tray */}
                    <div className="bg-white border-b border-gray-100 px-4 py-4 sm:px-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="bg-white/50 backdrop-blur-sm px-4 sm:px-6 py-3 flex flex-col gap-3 sm:gap-4 lg:flex-row lg:items-center lg:justify-between border-b border-gray-100/50">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 flex-1 w-full">
                            ...
                            {searchParams.toString() && (
                                <Button variant="ghost" size="sm" onClick={clearFilters} className="text-gray-500 hover:text-red-500 gap-1 self-start sm:self-auto">
                                        ...
                                        return (
                                            <div key={article.id} className="group relative h-full">
                                                <Link to={`/knowledge/${article.id}`} className="block h-full">
                                                    <Card className={cn(
                                                        "h-full overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border-gray-100 bg-white",
                                                        viewMode === 'list' && "sm:flex sm:flex-row sm:items-center sm:p-0"
                                                    )}>
                                                        <div className={cn(
                                                            "relative",
                                                            viewMode === 'grid'
                                                                ? "h-1.5 w-full bg-gradient-to-r from-hotel-navy to-hotel-gold"
                                                                : "h-1.5 w-full bg-hotel-navy sm:h-full sm:w-1.5"
                                                        )} />

                                                        <CardContent className={cn("p-5 flex flex-col h-full", viewMode === 'list' && "gap-4 sm:flex-row sm:items-center sm:gap-6 sm:flex-1 sm:py-4")}>
                                                            <div className={cn(
