...
import { usePracticalAssessments, usePracticalSubmissions, useSubmitPracticalEvaluation } from '@/hooks/usePracticalAssessments'
...
export default function InstructorWorkspace() {
  ...
  const { data: practicalSubmissions = [] } = usePracticalSubmissions({
    hotelId: activeHotelId || undefined
  })
