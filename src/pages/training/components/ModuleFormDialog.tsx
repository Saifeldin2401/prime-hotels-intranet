...
export function ModuleFormDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="w-[calc(100vw-1.5rem)] max-w-2xl max-h-[90vh] overflow-y-auto bg-white dark:bg-slate-950 border-hotel-gold/20 shadow-2xl">
                ...
                <Form onSubmit={form.handleSubmit(onSubmit)} className={`space-y-6 ${isRTL ? 'text-right' : 'text-left'}`}>
                    ...
                    <div className="flex flex-col-reverse gap-3 pt-6 border-t border-gray-100 mt-6 sm:flex-row sm:justify-end">
                        <Button
                            type="button"
                            variant="outline"
