...
const RiskQueuePage = lazy(() => import('@/features/manage/pages/RiskQueuePage'))
...
const TeamPage = lazy(() => import('@/features/manage/pages/TeamPage'))
...
export const ManageRoutes = () => (
    <Route element={<TenantContextGuard resourceName="Manage" />} errorElement={<RouteErrorBoundary section="Manage" />}>
        <Route path="/manage" element={<PreserveQueryNavigate to="/manage/risk" />} />
        <Route path="/manage/risk" element={page(<RiskQueuePage />, { capability: OVERSIGHT })} />
        ...
        <Route path="/manage/team" element={page(<TeamPage />, { capability: OVERSIGHT })} />
