...
export const ROUTES: RouteConfig[] = [
    ...
    { path: '/learn/courses', title: 'course_catalog', icon: Compass, group: 'learn', order: 3,
      description: 'Browse published courses',
      keywords: ['courses', 'catalog', 'explore'] },
    { path: '/learn/paths', title: 'training_paths', icon: Map, group: 'learn', order: 4,
    ...
    // -------------------------------------------------------------------------
    { path: '/studio', title: 'workspace.content_library', icon: BookOpen, group: 'studio', order: 1,
      requires: AUTHOR,
    ...
    { path: '/studio/quizzes', title: 'quizzes', icon: ListChecks, group: 'studio', order: 2,
      requires: AUTHOR,
    ...
    { path: '/studio/review', title: 'workspace.review_tasks', icon: ClipboardCheck, group: 'studio', order: 4,
      requires: ['content.publish'],
      description: 'Content waiting for approval',
      keywords: ['review', 'approve', 'publish'] },
    { path: '/studio/media', title: 'media_library', icon: Upload, group: 'studio', order: 5,
      requires: AUTHOR, hideFromNav: true,
    ...
    // -------------------------------------------------------------------------
    { path: '/manage/compliance', title: 'workspace.compliance', icon: ShieldCheck, group: 'manage', order: 1,
      requires: OVERSIGHT,
    ...
    { path: '/manage/assignments/quizzes', title: 'workspace.quiz_assignments', icon: ListChecks, group: 'manage', order: 3,
      requires: ['assignment.manage'],
      description: 'Assign quizzes to people, departments or roles',
      keywords: ['quiz', 'assign quiz'] },
    { path: '/manage/team', title: 'workspace.team_progress', icon: Users, group: 'manage', order: 3,
      requires: OVERSIGHT,
      description: 'Department ranking, overdue bottlenecks and skill risk',
      keywords: ['team', 'department', 'progress', 'executive'] },
    { path: '/manage/certificates', title: 'all_certificates', icon: Award, group: 'manage', order: 4,
      requires: ['certificate.issue'],
      description: 'Issued certificates and manual issuance',
      keywords: ['certificates', 'issue'] },
    { path: '/manage/reports', title: 'workspace.evidence', icon: FileBarChart, group: 'manage', order: 5,
    ...
    { path: '/manage/skills', title: 'skills_matrix', icon: Activity, group: 'manage', order: 7,
      requires: OVERSIGHT,
    ...
    { path: '/admin/properties', title: 'workspace.hotels_departments', icon: Building, group: 'organization', order: 3,
      requires: ['org.admin'],
      description: 'Hotels and their departments',
      keywords: ['hotels', 'properties', 'departments'] },
    ...
    { path: '/admin/export', title: 'tenant_data_export', icon: Upload, group: 'organization', order: 6,
      requires: ['org.settings'],
    ...
    // -------------------------------------------------------------------------
    { path: '/platform', title: 'platform_control_center', icon: Crown, group: 'platform_operations', order: 1,
    ...
    { path: '/platform/users', title: 'platform_user_directory', icon: Users, group: 'platform_operations', order: 5,
    ...
    { path: '/platform/analytics', title: 'platform_analytics', icon: BarChart3, group: 'platform_operations', order: 6,
      platformPermission: 'tenant.read',
      description: 'Cross-tenant usage metrics',
      keywords: ['analytics', 'usage', 'metrics'] },
    { path: '/platform/audit', title: 'cross_tenant_audit', icon: Shield, group: 'platform_operations', order: 7,
      platformPermission: 'tenant.read',
      description: 'Audit trail of operator actions and tenant sessions',
      keywords: ['audit', 'impersonation'] },
    { path: '/platform/settings', title: 'platform_settings', icon: Settings, group: 'platform_operations', order: 8,
      platformPermission: 'config.manage',
      description: 'Feature flags and runtime configuration',
      keywords: ['feature flags', 'config'] },
    { path: '/platform/ai-settings', title: 'ai_course_generator', icon: Bot, group: 'platform_operations', order: 9,
      platformPermission: 'config.manage',
      description: 'AI providers, routing and spend caps',
      keywords: ['ai', 'models', 'providers', 'spend cap'] },
    { path: '/platform/email-templates', title: 'email_templates', icon: Mail, group: 'platform_operations', order: 10,
      platformPermission: 'config.manage',
