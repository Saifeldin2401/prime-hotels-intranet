...
export const ROUTES: RouteConfig[] = [
    // -------------------------------------------------------------------------
    // 1. MY WORKSPACE GROUP (personal_space)
    // -------------------------------------------------------------------------
    {
        path: '/dashboard',
        title: 'dashboard',
    ...
    // -------------------------------------------------------------------------
    // 2. HOTEL OPERATIONS GROUP (hotel_operations)
    // -------------------------------------------------------------------------
    {
    ...
    // -------------------------------------------------------------------------
    // 3. FINANCE & COMMERCIAL GROUP (finance_revenue)
    // -------------------------------------------------------------------------
    {
    ...
    // -------------------------------------------------------------------------
    // 4. HR & PEOPLE MANAGEMENT GROUP (hr_staff)
    // -------------------------------------------------------------------------
    {
        path: '/directory',
        title: 'directory',
    ...
    },
    {
        ...
        title: 'my_team',
        icon: UsersRound,
        description: 'Your direct reports and their training progress',
        allowedRoles: ['corporate_admin', 'regional_admin', 'regional_hr', 'property_manager', 'property_hr', 'department_head'],
        keywords: ['team', 'direct reports', 'staff', 'roster'],
        group: 'hr_staff',
        order: 4,
    },
    {
    ...
    },
    {
        ...
        allowedRoles: ['corporate_admin', 'regional_admin', 'regional_hr', 'property_manager', 'property_hr'],
        keywords: ['referral', 'refer a friend', 'recruiting'],
        group: 'hr_staff',
        order: 9,
    },
    {
    ...
    },
    {
        ...
        title: 'skills_matrix',
        icon: Shield,
        description: 'Team skill coverage and gaps',
        allowedRoles: ['corporate_admin', 'regional_admin', 'regional_hr', 'property_manager', 'property_hr', 'department_head'],
        group: 'hr_staff',
        order: 8.5,
    },
    ...
    // -------------------------------------------------------------------------
    // 5. KNOWLEDGE & SOPS GROUP (knowledge_sop)
    // -------------------------------------------------------------------------
    {
        path: '/knowledge',
    ...
    },
    {
        ...
        title: 'media_library',
        icon: Image,
        description: 'Photo and video asset library',
        allowedRoles: 'all',
    ...
    // -------------------------------------------------------------------------
    // 6. REPORTS & INTELLIGENCE GROUP (reports_analytics)
    // -------------------------------------------------------------------------
    {
        path: '/reports',
        title: 'reports',
    ...
    // -------------------------------------------------------------------------
    // 7. SYSTEM ADMINISTRATION GROUP (administration)
    // -------------------------------------------------------------------------
    {
        path: '/admin/users',
    ...
    },
    {
        ...
        icon: Mail,
        description: 'Manage HTML and Text structures for system emails',
        allowedRoles: ['corporate_admin', 'regional_admin'],
        group: 'administration',
        order: 10.5,
    },
    {
        ...
        title: 'email_analytics',
        icon: Activity,
        description: 'Monitor email delivery performance and template usage',
        allowedRoles: ['corporate_admin', 'regional_admin'],
        group: 'administration',
        order: 10.6,
    },
    {
        ...
        icon: Award,
        description: 'View all certificates across the organization',
        allowedRoles: ['corporate_admin', 'regional_admin', 'regional_hr', 'property_manager'],
        group: 'administration',
        order: 10.7,
    },
    {
        ...
        icon: Award,
        description: 'Manually issue certificates to users',
        allowedRoles: ['corporate_admin', 'regional_admin', 'regional_hr', 'property_manager'],
        group: 'administration',
        order: 10.8,
    },
