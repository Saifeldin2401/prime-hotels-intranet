  ...
  const handleSelectPlatformPlane = async () => {
    try {
      ...
      toast({
        ...
        description: error?.message || 'Failed to return to platform',
        variant: 'destructive',
      })
    }
  }
            ...
            <div className="space-y-4 py-3">
              ...
              <div className="space-y-1.5">
                ...
                <Select value={actingRole} onValueChange={setActingRole}>
                  <SelectTrigger id="capsule-acting-role" className="bg-slate-900 border-white/10 text-white text-xs focus:ring-hotel-gold">
                    <SelectValue />
                  </SelectTrigger>
