...
export function PlayerContextRail({
    ...
    return (
        <nav
            aria-label={t('player.lessonNavigation', 'Lesson navigation')}
        ...
        >
            <div className="border-b border-ds-chrome-border p-5">
                ...
                <div
                    className="h-1.5 w-full overflow-hidden rounded-full bg-ds-chrome-raised"
                    role="progressbar"
                ...
                >
                    <div className="h-full rounded-full bg-ds-chrome-accent transition-[width] duration-700" style={{ width: `${rounded}%` }} />
                </div>
            </div>
                                ...
                                <span className="min-w-0 flex-1">
                                    <span
                                        className={cn(
                                            ...
                                            isActive ? 'text-ds-chrome-text' : isLocked ? 'text-ds-chrome-muted/70' : 'text-ds-chrome-text',
                                        )}
                                    >
                                        {item.title}
                                    </span>
