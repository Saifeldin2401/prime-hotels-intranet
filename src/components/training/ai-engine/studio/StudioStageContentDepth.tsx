...
export function StudioStageContentDepth({
  ...
  const DEPTH_PRESETS: Array<{
    ...
    },
    {
      ...
      desc: 'Exhaustive domain training, Forbes 5-star nuances, edge cases, and multi-step checklists.',
  ...
  const COMPONENT_OPTIONS: Array<{
    ...
    },
    {
      ...
      desc: 'Forbes 5-star verbatim phrases, greetings, and active listening scripts.',
